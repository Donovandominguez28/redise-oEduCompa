...
body {
  ...
  --text-color: var(--sonic-silver);
  --background-alt-color: var(--cultured);
  --text-alt-color: var(--spanish-gray);
  --highlight-color: var(--desert-sand);
...
.dark-theme {
  ...
  --background-alt-color: var(black);
  --text-alt-color: var(--spanish-gray);
  --highlight-color: var(--onyx);
  --link-color: var(white);
  background-color: var(--background-color);
  color: var(--text-color);
}
